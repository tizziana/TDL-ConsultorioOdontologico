...
// Obtiene el valor que se encuentra en la posición actual
// Pre: el iterador fue creado
// Post: devuelve el dato actual. Devuelve NULL si está al final
// de la lista
void *lista_iter_ver_actual(const lista_iter_t *iter);

// Verifica si ya está al final de la lista, devuelve false en caso contrario.
// Pre: el iterador fue creado
...
// Agrega un elemento en la posición actual, devuelve false en caso de error.
// Pre: el iterador fue creado
