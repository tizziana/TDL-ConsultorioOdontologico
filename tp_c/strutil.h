 ...
 * 
 * Pre: existe una cadena  
 * Post: se devuelve una cadena dinamica con elementos de la cadena
 */
 ...
 * 
 * Pre: existe una cadena
 * Post: se devuelve un arreglo dinamico de cadenas dinamicas
 * con los elementos de la cadena
 */
 ...
 * esta función. La función devuelve NULL en caso de error.
 * 
 * Pre: existe un arreglo de cadenas
 * Post: devuelve una cadena dinamica con los elementos del arreglo
 */
 ...
 * 
 * Pre: existe un arreglo dinamico de cadenas dinamicas
 */
